<template>
  <div>
    ...
    <div class="w-84 md:w-100 mx-auto text-black">
      ...
      <div class="flex items-center justify-between bg-blue-900 text-white p-3 rounded-lg">
        <div>
          <span class="block text-base font-bold leading-snug">Referí a un amigo y te</span>
          <span class="block text-base font-bold leading-snug">regalamos tu próxima cuota.</span>
          <button
            class="btn-big-outline text-white text-xs"
            @click="clickDocumentacion"
          >Quiero saber más</button>
        </div>
        <div>
          <img :src="img.faces" alt="faces" />
        </div>
      </div>

      <div class="flex items-center justify-between bg-green-800 text-white p-3 rounded-lg mt-4">
        <div>
          <span class="block text-base font-bold leading-snug">Completá tu info de contacto</span>
          <span class="block text-base font-bold leading-snug">y te bonificamos $100.</span>
          <button class="btn-big-outline text-white text-xs" @click="clickDocumentacion">Completar</button>
        </div>
        <div>
          <img :src="img.hand" alt="hand" />
        </div>
      </div>

      <div
        class="flex items-center justify-between bg-yellow-800 text-black p-3 rounded-lg mt-4 mb-4"
      >
        <div>
          <span class="block text-base font-bold leading-snug">¿Algún problema? Estamos</span>
          <span class="block text-base font-bold leading-snug">disponibles para ayudarte.</span>

          <button
            class="btn-big-outline text-black text-xs"
            @click="clickDocumentacion"
          >Ir al centro de ayuda</button>
        </div>
        <div>
          <img :src="img.bubles" alt="bubles" />
        </div>
      </div>
...
import imgFaces from "../assets/images/faces.svg";
import imgHand from "../assets/images/hand.svg";
import imgBubles from "../assets/images/bubles.svg";
